package game.Typing;
import game.Typing.Language;
import game.Typing.KeyAttr;
...
public class MainLanguage extends Language{
	...
	public MainLanguage() {
		...
		myKey51.code = 52;
		myKey51.label = "\u094D\u0930" ;//rashtra chinha
        ...
        KeyAttr myKey136  = new KeyAttr();
        myKey136.code = 137;
        myKey136.label = "\u090b";//"\u0937\u094d\u091f" ;
        myKey136.showChakra = true ;
        myKey136.showCustomChakra = true ;
        myKey136.customChakraLayout = new String[] {"\u090b","\u0944", "\u0960", "\u0901", "\u0946", "\u094a", "\u093d","\u0972", "\u0949", "\u0911"} ;
        myKey136.showIcon = false  ;
        myKey136.icon = "";
        myKey136.changeLayout = false ;
        myKey136.layout = "";
        myKey.set(136, myKey136);

            KeyAttr myKey137  = new KeyAttr();
            myKey137.code = 138;
            myKey137.label = "" ;
            myKey137.showChakra = true ;
            myKey137.showCustomChakra = false ;
            myKey137.customChakraLayout = new String[] {} ;
            myKey137.showIcon = true;
            myKey137.icon = "ic_mic_white_24dp";
            myKey137.changeLayout = false ;
            myKey137.layout = "";
            myKey.set(137, myKey137);

            /*KeyAttr myKey138  = new KeyAttr();
            myKey138.code = 139;
            myKey138.label = "C" ;
            myKey138.showChakra = true ;
            myKey138.showCustomChakra = false ;
            myKey138.customChakraLayout = new String[] {} ;
            myKey138.showIcon = false;
            myKey138.icon = "";
            myKey138.changeLayout = false ;
            myKey138.layout = "";
            myKey.set(139, myKey138);

            KeyAttr myKey139  = new KeyAttr();
            myKey139.code = 140;
            myKey139.label = "W" ;
            myKey139.showChakra = true ;
            myKey139.showCustomChakra = false ;
            myKey139.customChakraLayout = new String[] {} ;
            myKey139.showIcon = false;
            myKey139.icon = "";
            myKey139.changeLayout = false ;
            myKey139.layout = "";
            myKey.set(140, myKey139);*/
