...
public class KeyAttr {
	 ...
	 * @param changeLayout
	 * @param layout
	 * @param exampleWord word to be read as hint
	 */
	public KeyAttr(int code, String label, boolean showIcon, String icon, boolean showChakra,
			...
			boolean changeLayout, String layout, boolean isException,String word){
		this.code = code;
		this.label = label;
